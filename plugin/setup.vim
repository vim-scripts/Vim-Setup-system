...
" the function itself.
" ----------------------------------------------------------------------------
" fix for vim 7 problem
let g:echowarningmessages = "" 
"-----------------------------------------------------------------------------
...
exec "so ". s:vimhome."/plugin/arrayg.vim"
exec "so ". s:vimhome."/plugin/fun.vim"
exec "so ".s:vimhome."/plugin/strfun.vim"
exec "so ".s:vimhome."/plugin/tableaf.vim"

" Import settings from these files HERE:
let setup_files=Arr("~/test.vim")                
...
" Customize HERE1 to restore your mappings after leaving the editor.
  au bufleave _setup so ~/test.vim
aug END
